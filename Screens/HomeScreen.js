        ...
        <SafeAreaView style={tw("flex-1")}>
            ...
            <View style={tw("flex-row items-center justify-between px-5")}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Modal")}>
                    <Image style={tw("h-14 w-14 rounded-full")} source={require("../image/logo1.1.png")}/>
                </TouchableOpacity>
            ...
            <View style={tw("flex-1 -mt-6")}>
                <Swiper ref={swipeRef}  containerStyle={{backgroundColor: "transparent"}}
            cards={profiles} 
            stackSize={5}
            cardIndex={0}
            animateCardOpacity
            ...
            renderCard={(card) => card ? (
                <View key={card.id} style={tw("relative bg-blue-500 h-3/4 rounded-xl")}>
                    <Image style={tw("h-full w-full")} source={{ uri: card.photoURL}} />
                
                
                <View style={tw("absolute bottom-0 bg-white w-full justify-between flex-row items-center h-20 px-6 py-2")}>
                    <View >
